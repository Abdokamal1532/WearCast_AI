        ...
        **kwargs,
        ...
        if output_type != "latent":
            try:
                ...
                # Smooth 0ΓåÆ1 transition ONLY at the exact edge (8px wide).
                ...
                #   - Vivid red (S=240, V=220) ΓåÆ muted maroon (S=150, V=140)
                #   - Bright blue ΓåÆ muted slate-blue
                #
                ...
                # Capped at 1.8├ù to prevent oversaturation of already-correct results.
                # =====================================================================
                try:
                    # --- Original garment reference stats ---
                    garm_ref_01 = (image_garm.float() + 1.0) / 2.0  # [-1,1] ΓåÆ [0,1]
                    ...
                    if garm_s_ref is not None:
                        for b_idx in range(composited.shape[0]):
                            ...
                            blend_w = np.stack([feathered] * 3, axis=-1)  # H├ùW├ù3
